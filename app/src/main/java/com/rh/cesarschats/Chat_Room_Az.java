...
public class Chat_Room_Az extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_room_az);

        listMsg=(ListView) findViewById(R.id.listMsg3);
        ...
        btn_send_msg = (Button) findViewById(R.id.btn_send3);
        input_msg = (EditText) findViewById(R.id.msg_input3);

        chat_conversation = (ListView) findViewById(R.id.listMsg3);
        ...
        btn_send_msg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String cryptedmsg=CryptageAz.crypt(input_msg.getText().toString());
       ...
       // lay.addView(input_cle);
        ...
        builder.setPositiveButton("Decrypt", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                //cle= input_cle.getText().toString();


                String msgafter= CryptageAz.decrypt(msgbefore);
